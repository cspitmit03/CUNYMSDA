...
LOAD DATA LOCAL INFILE '/Users/cesarespitia/Documents/CUNYMSDA/Bridge/Week1/flights/airlines.csv' 
INTO TABLE airlines 
...
LOAD DATA LOCAL INFILE '/Users/cesarespitia/Documents/CUNYMSDA/Bridge/Week1/flights/airports.csv' 
INTO TABLE airports
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA LOCAL INFILE '/Users/cesarespitia/Documents/CUNYMSDA/Bridge/Week1/flights/flights.csv' 
INTO TABLE flights
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA LOCAL INFILE '/Users/cesarespitia/Documents/CUNYMSDA/Bridge/Week1/flights/planes.csv' 
INTO TABLE planes
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA LOCAL INFILE '/Users/cesarespitia/Documents/CUNYMSDA/Bridge/Week1/flights/weather.csv' 
INTO TABLE weather
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
-- THE FLIGHT FROM JFK TO HNL IS THE FURTHEST DISTANCE FROM EACH OTHER
